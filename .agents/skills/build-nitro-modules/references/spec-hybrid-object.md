...
export interface PlatformContext extends HybridObject<{
  ios: 'swift';
  android: 'kotlin';
}> {
...
export interface StorageFactory extends HybridObject<{
  ios: 'c++';
  android: 'c++';
}> {
...
export interface VideoOutput extends HybridObject<{
  ios: 'swift';
  android: 'kotlin';
}> {
...
```typescript
// Avoid.
export interface ScannedData extends HybridObject<{
  ios: 'swift';
  android: 'kotlin';
}> {
...
export interface ScannedItem extends HybridObject<{
  ios: 'swift';
  android: 'kotlin';
}> {
  readonly id: string;
 ...
 */
export interface MediaOutput extends HybridObject<{
  ios: 'swift';
  android: 'kotlin';
}> {
